...
PLANS: Dict[str, Dict[str, Any]] = {
    ...
    # ──────────────────────────────────────────────────────────────────────
    # NEW PLANS — Capivara Module System (added March 2026)
    # The old plans (professional/executive) are kept for backward compat.
    # ──────────────────────────────────────────────────────────────────────
    "ara": {
        "display_name": "ARA",
        "price_eur": 19.99,
        "description": "Your day, before it begins — Life & Time assistant",
        "quotas": {
            "gpt_tokens": 150_000,
            "image_gen": 0,
            "video_gen": 0,
    ...
    "ara_plus_1": {
        "display_name": "ARA + 1 Capivara",
        "price_eur": 27.99,
        "description": "ARA + one additional capivara module",
        "quotas": {
            "gpt_tokens": 200_000,
            "image_gen": 10,
            "video_gen": 2,
            "twilio_mins": 10,
            "elevenlabs_chars": 80_000,
            "google_places": 300,
            "maps_reqs": 300,
            "search_reqs": 500,
            "weather_reqs": 800,
    ...
    "capivarex_pro": {
        "display_name": "CAPIVAREX Pro",
        "price_eur": 44.99,
        "description": "ARA + 3 capivara modules",
        "quotas": {
            "gpt_tokens": 400_000,
            "image_gen": 50,
            "video_gen": 10,
            "twilio_mins": 30,
            "elevenlabs_chars": 150_000,
            "google_places": 600,
            "maps_reqs": 600,
            "search_reqs": 800,
            "weather_reqs": 1_500,
    ...
    "capivarex_ultimate": {
        "display_name": "CAPIVAREX Ultimate",
        "price_eur": 89.99,
        "description": "All 8 capivara modules unlocked",
        "quotas": {
            "gpt_tokens": 999_999,
            "image_gen": 200,
            "video_gen": 50,
            "twilio_mins": 120,
            "elevenlabs_chars": 500_000,
            "google_places": 2_000,
            "maps_reqs": 2_000,
            "search_reqs": 2_000,
            "weather_reqs": 5_000,
            "crypto_reqs": 2_000,
            "youtube_reqs": 1_000,
            "translate_reqs": 2_000,
            "tracking_reqs": 500,
            "perplexity_reqs": 1_000,
            "smartcar_reqs": 1_000,
            "mercado_scans": 500,
            "reminders": 500,
            "notes": 5_000,
