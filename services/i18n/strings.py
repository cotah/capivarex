...
STRINGS: Dict[str, Dict[str, str]] = {
    ...
    # ══════════════════════════════════════════════════════════════
    # Proactive Price Drop Alerts
    # ══════════════════════════════════════════════════════════════
    "mercado_price_drops_header": {
        "en": "📉 Good news! Some prices dropped:",
        "pt": "📉 Boas notícias! Alguns preços baixaram:",
        "es": "📉 ¡Buenas noticias! Algunos precios bajaron:",
    },
    "mercado_price_drop_item": {
        "en": "  🏷️ {product} — €{price} at {store} (was €{old_price}, {change}%)",
        "pt": "  🏷️ {product} — €{price} no {store} (era €{old_price}, {change}%)",
        "es": "  🏷️ {product} — €{price} en {store} (era €{old_price}, {change}%)",
    },
    "mercado_price_drops_savings": {
        "en": "\n💰 Potential savings: €{total} on these items!",
        "pt": "\n💰 Poupança potencial: €{total} nestes itens!",
        "es": "\n💰 Ahorro potencial: €{total} en estos artículos!",
    },
    # ══════════════════════════════════════════════════════════════
    # Shopping Reminder
    # ══════════════════════════════════════════════════════════════
    "mercado_shopping_reminder": {
        "en": "🛒 You have {count} items on your shopping list for {days} days!\n\n📝 {items}",
        "pt": "🛒 Tens {count} itens na lista de compras há {days} dias!\n\n📝 {items}",
        "es": "🛒 ¡Tienes {count} artículos en la lista de compras hace {days} días!\n\n📝 {items}",
    },
    ...
    "mercado_list_cleared_done": {
        "en": "✅ Shopping list cleared! Hope you got everything 🛍️",
        "pt": "✅ Lista de compras limpa! Espero que tenhas comprado tudo 🛍️",
        "es": "✅ ¡Lista de compras limpia! Espero que hayas comprado todo 🛍️",
    },
    "mercado_reminder_snoozed": {
        "en": "🔕 OK, I'll remind you tomorrow!",
        "pt": "🔕 OK, lembro-te amanhã!",
        "es": "🔕 ¡OK, te recuerdo mañana!",
    },
    # ══════════════════════════════════════════════════════════════
    # Media Cast
    # ══════════════════════════════════════════════════════════════
    ...
    "media_cast_tip": {
        "en": "💡 Tap a link, then tap the Cast icon 📲 to send to your TV!",
        "pt": "💡 Toca no link e depois no ícone Cast 📲 pra enviar pra TV!",
    ...
    # ══════════════════════════════════════════════════════════════
    "music_now_playing": {
        "en": "▶️ Now playing: **{track}** by {artist}",
        "pt": "▶️ A tocar: **{track}** de {artist}",
        "es": "▶️ Reproduciendo: **{track}** de {artist}",
    },
    "music_paused": {
        "en": "⏸ Music paused.",
        "pt": "⏸ Música pausada.",
    ...
    "music_next": {
        "en": "⏭ Skipped to next track.",
        "pt": "⏭ Próxima faixa.",
        "es": "⏭ Siguiente canción.",
    },
    "music_previous": {
        "en": "⏮ Back to previous track.",
        "pt": "⏮ Faixa anterior.",
        "es": "⏮ Canción anterior.",
    },
    "music_volume_set": {
        "en": "🔊 Volume set to {volume}%",
        "pt": "🔊 Volume definido em {volume}%",
        "es": "🔊 Volumen al {volume}%",
    },
    "music_currently_playing": {
        "en": "🎵 Currently playing: **{track}** by {artist}",
        "pt": "🎵 A tocar agora: **{track}** de {artist}",
        "es": "🎵 Reproduciendo: **{track}** de {artist}",
    },
    "music_nothing_playing": {
        "en": "🔇 Nothing is playing right now.",
        "pt": "🔇 Nada está a tocar agora.",
        "es": "🔇 No se está reproduciendo nada.",
    },
    "music_added_to_playlist": {
        "en": "✅ Added **{track}** to playlist **{playlist}**!",
        "pt": "✅ **{track}** adicionado à playlist **{playlist}**!",
        "es": "✅ **{track}** añadido a la playlist **{playlist}**!",
    },
    "music_connect_spotify": {
        "en": "🎵 To control Spotify, connect your account first:\n\n[🔗 Connect Spotify]({url})",
        "pt": "🎵 Para controlar o Spotify, conecta a tua conta primeiro:\n\n[🔗 Conectar Spotify]({url})",
        "es": "🎵 Para controlar Spotify, conecta tu cuenta primero:\n\n[🔗 Conectar Spotify]({url})",
    },
    "music_play_failed": {
        "en": "❌ Couldn't play. Make sure Spotify is open on a device.",
        "pt": "❌ Não consegui tocar. Verifica se o Spotify está aberto num device.",
    ...
    "music_nothing_to_add": {
        ...
        "pt": "🔇 Nada está a tocar para adicionar à playlist.",
        "es": "🔇 No hay nada reproduciendo para añadir.",
    },
    "music_no_playlists": {
        "en": "📋 You don't have any playlists yet.",
        "pt": "📋 Ainda não tens playlists.",
        "es": "📋 Aún no tienes playlists.",
    },
    "music_pause_failed": {
        "en": "❌ Couldn't pause playback.",
        "pt": "❌ Não consegui pausar.",
        "es": "❌ No pude pausar.",
    },
    "music_next_failed": {
        "en": "❌ Couldn't skip track.",
        "pt": "❌ Não consegui avançar.",
        "es": "❌ No pude avanzar.",
    },
    "music_previous_failed": {
        "en": "❌ Couldn't go back.",
        "pt": "❌ Não consegui voltar.",
        "es": "❌ No pude retroceder.",
    },
    "music_volume_failed": {
        "en": "❌ Couldn't change volume.",
        "pt": "❌ Não consegui mudar o volume.",
        "es": "❌ No pude cambiar el volumen.",
    },
    "music_unknown_action": {
        "en": "❓ I didn't understand that music command.",
        "pt": "❓ Não entendi esse comando de música.",
        "es": "❓ No entendí ese comando de música.",
    },
    "music_spotify_not_configured": {
        "en": "⚠️ Spotify integration is not configured.",
        "pt": "⚠️ Integração Spotify não está configurada.",
        "es": "⚠️ La integración de Spotify no está configurada.",
    },
    "music_add_failed": {
        "en": "❌ Couldn't add track to playlist.",
        "pt": "❌ Não consegui adicionar à playlist.",
        "es": "❌ No pude añadir a la playlist.",
    },
}
