...
- 'mercado': Shopping list, supermarket, receipt, add/remove items, spending report, compare prices, store ranking, export excel, download report, exportar relatório, voice shopping list, add items by voice.
