...
class TestParseEvents:
    ...
    def test_skip_all_day_events(self):
        events = [
            {"id": "1", "summary": "Holiday", "start": "2026-03-20", "end": "2026-03-21"},
...
class TestCheckPair:
    ...
    def test_overlapping_events(self):
        ...
        ev_a = {
            "id": "1", "summary": "Meeting A", "location": "",
            "start_dt": now, "end_dt": now + timedelta(hours=1),
            "start_str": "Mon 14:00", "end_str": "15:00",
        }
        ev_b = {
            "id": "2", "summary": "Meeting B", "location": "",
            "start_dt": now + timedelta(minutes=30), "end_dt": now + timedelta(hours=1, minutes=30),
            "start_str": "Mon 14:30", "end_str": "15:30",
        }
    ...
    def test_no_overlap(self):
        ...
        ev_b = {
            "id": "2", "summary": "Meeting B", "location": "",
            "start_dt": now + timedelta(hours=2), "end_dt": now + timedelta(hours=3),
            "start_str": "Mon 16:00", "end_str": "17:00",
        }
        result = _check_pair(ev_a, ev_b)
    ...
    def test_tight_gap_different_locations(self):
        now = datetime.now(timezone.utc)
        ev_a = {
            "id": "1", "summary": "Meeting A", "location": "Office",
            "start_dt": now, "end_dt": now + timedelta(hours=1),
            "start_str": "Mon 14:00", "end_str": "15:00",
        }
        ev_b = {
            "id": "2", "summary": "Meeting B", "location": "Client HQ",
            "start_dt": now + timedelta(hours=1, minutes=10), "end_dt": now + timedelta(hours=2),
            "start_str": "Mon 15:10", "end_str": "16:00",
        }
        result = _check_pair(ev_a, ev_b)
        assert result is not None
    ...
    def test_tight_gap_same_location_no_conflict(self):
        ...
        ev_b = {
            "id": "2", "summary": "Meeting B", "location": "Office",
            "start_dt": now + timedelta(hours=1, minutes=10), "end_dt": now + timedelta(hours=2),
            "start_str": "Mon 15:10", "end_str": "16:00",
        }
        result = _check_pair(ev_a, ev_b)
    ...
    def test_adjacent_events_no_gap_no_location(self):
        ...
        ev_b = {
            "id": "2", "summary": "Meeting B", "location": "",
            "start_dt": now + timedelta(hours=1), "end_dt": now + timedelta(hours=2),
            "start_str": "Mon 15:00", "end_str": "16:00",
        }
        result = _check_pair(ev_a, ev_b)
...
class TestAlertGeneration:
    ...
    async def test_fallback_alert_overlap(self):
        conflicts = [{
            "type": "overlap",
            "event_a": {"id": "1", "summary": "Meeting A", "start_str": "Mon 14:00", "end_str": "15:00"},
            "event_b": {"id": "2", "summary": "Meeting B", "start_str": "Mon 14:30", "end_str": "15:30"},
    ...
    async def test_gpt_alert(self):
        ...
        with patch("services.business.agenda_conflict_service.get_service", return_value=mock_openai):
            result = await generate_conflict_alert("Marcos", conflicts)
        assert "Marcos" in result
