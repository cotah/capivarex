...
# Ensure ENCRYPTION_KEY is available for all tests (CI has no .env file).
os.environ.setdefault("ENCRYPTION_KEY", Fernet.generate_key().decode())

# Pre-import encryption module so it's cached in sys.modules before any test
# clears the environment with patch.dict(clear=True).
