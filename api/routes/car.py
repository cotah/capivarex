...
@router.post("/query")
async def query_car(request: CarQueryRequest, current_user: Dict[str, Any] = Depends(get_current_user)) -> Dict[str, Any]:
    """
...
@router.post("/connect")
async def connect_vehicle(request: CarConnectRequest, current_user: Dict[str, Any] = Depends(get_current_user)) -> Dict[str, Any]:
    """
...
@router.post("/refresh")
async def refresh_token(refresh_token: str, current_user: Dict[str, Any] = Depends(get_current_user)) -> Dict[str, Any]:
    """
...
@router.get("/battery")
async def get_battery(vehicle_id: str, access_token: str, current_user: Dict[str, Any] = Depends(get_current_user)) -> Dict[str, Any]:
...
@router.get("/location")
async def get_location(vehicle_id: str, access_token: str, current_user: Dict[str, Any] = Depends(get_current_user)) -> Dict[str, Any]:
...
async def get_charge_status(vehicle_id: str, access_token: str, current_user: Dict[str, Any] = Depends(get_current_user)) -> Dict[str, Any]:
...
@router.get("/summary")
async def get_summary(vehicle_id: str, access_token: str, current_user: Dict[str, Any] = Depends(get_current_user)) -> Dict[str, Any]:
...
@router.post("/lock")
async def lock_vehicle(vehicle_id: str, access_token: str, current_user: Dict[str, Any] = Depends(get_current_user)) -> Dict[str, Any]:
...
@router.post("/unlock")
async def unlock_vehicle(vehicle_id: str, access_token: str, current_user: Dict[str, Any] = Depends(get_current_user)) -> Dict[str, Any]:
...
async def start_charging(vehicle_id: str, access_token: str, current_user: Dict[str, Any] = Depends(get_current_user)) -> Dict[str, Any]:
...
async def stop_charging(vehicle_id: str, access_token: str, current_user: Dict[str, Any] = Depends(get_current_user)) -> Dict[str, Any]:
