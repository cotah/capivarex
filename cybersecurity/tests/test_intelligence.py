...
class TestConfidenceScorer:
    ...
    def test_extract_fix_from_content(self):
        from cybersecurity.intelligence.confidence_scorer import (
            _extract_fix_from_content,
        )

        content = (
            "Finding: XSS in input\nResolution: Use DOMPurify\nTrue positive: True"
        )
...
class TestPatternRecognition:
    ...
    async def test_detect_escalating_without_db(self):
        from cybersecurity.intelligence.pattern_recognition import (
            detect_escalating_threats,
        )
