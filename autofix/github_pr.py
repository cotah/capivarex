...
def _clone_repo(owner: str, repo: str, token: str, dest: Path) -> None:
    ...
    _run(["git", "config", "user.name", "CAPIVAREX AutoFix"], cwd=dest)
...
def _commit_and_push(
    ...
    commit_msg = (
        ...
        f"Auto-generated patch by CAPIVAREX AutoFix.\n"
...
def _open_pull_request(
    ...
    body = (
        ...
        f"> This PR was auto-generated by CAPIVAREX AutoFix and approved by the admin via Telegram.\n"
